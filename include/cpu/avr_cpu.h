...
public:
  ...
  u8 exec_adiw(u16 opcode);
  u8 exec_andi(u16 opcode);
  ...
  u8 exec_ld_z(u16 opcode);
  u8 exec_ld_z_post_inc(u16 opcode);
  u8 exec_ld_z_pre_dec(u16 opcode);
  u8 exec_ld_z_disp(u16 opcode);
  u8 exec_st_z(u16 opcode);
  u8 exec_st_z_post_inc(u16 opcode);
  u8 exec_st_z_pre_dec(u16 opcode);
  u8 exec_st_z_disp(u16 opcode);
  u8 exec_st_y(u16 opcode);
  u8 exec_st_y_post_inc(u16 opcode);
  u8 exec_st_y_pre_dec(u16 opcode);
  u8 exec_st_y_disp(u16 opcode);
  ...
  u8 exec_ijmp(u16 opcode);
  u8 exec_icall(u16 opcode);
  u8 exec_sbrs(u16 opcode);
