...
static const std::array<InstructionDesc, 69> kInstructionTable = {{
    // mask  pattern name
    // misc
    ...
    {0xFE0F, 0x8008, "LD Y",   &AvrCpu::exec_ld_y},
    {0xFE0F, 0x9009, "LD Y+",  &AvrCpu::exec_ld_y_post_inc},
    {0xFE0F, 0x900A, "LD -Y",  &AvrCpu::exec_ld_y_pre_dec},
    {0xD208, 0x8008, "LD Y+q", &AvrCpu::exec_ld_y_disp},
    {0xFE0F, 0x8000, "LD Z",   &AvrCpu::exec_ld_z},
    {0xFE0F, 0x9001, "LD Z+",  &AvrCpu::exec_ld_z_post_inc},
    {0xFE0F, 0x9002, "LD -Z",  &AvrCpu::exec_ld_z_pre_dec},
    {0xD208, 0x8000, "LD Z+q", &AvrCpu::exec_ld_z_disp},
    {0xFE0F, 0x8200, "ST Z",   &AvrCpu::exec_st_z},
    {0xFE0F, 0x9201, "ST Z+",  &AvrCpu::exec_st_z_post_inc},
    {0xFE0F, 0x9202, "ST -Z",  &AvrCpu::exec_st_z_pre_dec},
    {0xD208, 0x8200, "ST Z+q", &AvrCpu::exec_st_z_disp},
    {0xFE0F, 0x8208, "ST Y",   &AvrCpu::exec_st_y},
    {0xFE0F, 0x9209, "ST Y+",  &AvrCpu::exec_st_y_post_inc},
    {0xFE0F, 0x920A, "ST -Y",  &AvrCpu::exec_st_y_pre_dec},
    {0xD208, 0x8208, "ST Y+q", &AvrCpu::exec_st_y_disp},
    ...
    {0xFF00, 0x9600, "ADIW",   &AvrCpu::exec_adiw},
    {0xF000, 0x7000, "ANDI",   &AvrCpu::exec_andi},
    ...
    {0xFFFF, 0x9409, "IJMP",   &AvrCpu::exec_ijmp},
    {0xFFFF, 0x9509, "ICALL",  &AvrCpu::exec_icall},
    {0xFE08, 0xFE00, "SBRS",   &AvrCpu::exec_sbrs},
}};
